import { CategoryList, Category, CategoryListView, CategorySubcategories, CategoryName, CategorySlug, CategoryImage } from "~/components/ui/category"
  ...
  return (
    <div class="min-h-screen bg-gray-50 p-8">
      <div class="max-w-4xl mx-auto">
        ...
        <CategoryList>
          <Grid cols={3} gap={3}>
            <CategoryListView class="space-y-4">
              <Col class="m-3">
